...
Analyze this industry news item and classify it into exactly one relevance tier: Major, Notable, or Background.

Tier definitions:
- Major: Directly impacts SafelyYou's market, customers, or competitive position. Regulatory changes, major competitor moves, technology shifts affecting fall detection/senior care AI.
- Notable: Relevant to the senior living/AI space but not an immediate SafelyYou action item. Market trends, funding rounds, notable partnerships.
- Background: General senior living industry news. Routine coverage, tangential topics.
...
Return ONLY valid JSON:
{
  ...
  "relevance_summary": "1-2 sentences explaining relevance to SafelyYou specifically",
  "topics": ["lowercase-topic-tags"],
  "mentioned_accounts": ["company or organization names mentioned"]
}`;
